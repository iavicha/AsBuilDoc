...
class DoItPdf:
    ...
    def make_hwsc(self, request, id):
        # Create a file-like buffer to receive PDF data.
        buffer = io.BytesIO()
        act = HiddenWorksSurveyCertificate.objects.filter(id=id)
        ...
        number_of_copies = str(act.values("number_of_copies")[0]["number_of_copies"])
        norma = str(act.values("norma")[0]["norma"])
        mat = act.values("material")
        print(mat)
        for i in mat:
            mat1 = Material.objects.filter(id=i['material'])
            mat1_name = mat1.values('name')
            mat1_documents = mat1.values('documents')[0]["documents"]
            doc_ = Documents.objects.filter(id = mat1_documents)
            print(mat1_name, doc_)
        ...
        file.drawString(70, 794,
                        "(наименование проектной документации, почтовый или строительный адрес " 
        ...
        file.setFont("NotoSans", 8)
        file.drawString(100, 756,
                        "(фамилия, имя, отчество, адрес места жительства, ОГРНИП, ИНН индивидуального "
                        "предпринимателя,")
        file.setFont("NotoSans", 12)
        ...
        file.setFont("NotoSans", 8)
        file.drawString(70, 179,
                        "(должность, фамилия, инициалы, инициалы, реквизиты распорядительного документа," " подтверждающего полномочия,")
        file.setFont("NotoSans", 12)
        ...
        file.setFont("NotoSans", 8)
        file.drawString(15, 794,
                        "(должность с указанием наименования организации, фамилия, инициалы," "реквизиты распорядительного документа,")
        ...
        file.setFont("NotoSans", 12)
        file.drawString(15, 451, norma.title())
        ...
        file.drawString(15, 348, "Акт составлен в  {} экземплярах.".format(number_of_copies))
        ...
        return FileResponse(buffer, as_attachment=True, filename=number + "_" + job_name + ".pdf")
